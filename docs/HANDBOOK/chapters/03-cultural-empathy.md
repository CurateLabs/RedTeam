...
- [Ethnocentrism](../concepts/ethnocentrism.md) — Judging other cultures by the standards of one's own — the primary bias cultural empathy counteracts.
- [Operating Landscape Map](../concepts/operating-landscape-map.md) — Multi-domain map of the operating environment: power, security, economy, society, information, infrastructure, physical context, and time.
- [Kluckhohn's Six Dimensions](../concepts/kluckhohns-six-dimensions.md) — Age-old cultural variation axes for comparing cultural defaults (human nature, activity, time, relational, etc.).
