---
title: "`.redteam/` directory"
description: "When you run /redteam init, the skill writes decision context and stores review artifacts in a project-local directory."
sidebar:
  order: 6
---
